...
if (($_SERVER['REQUEST_METHOD'] === 'POST') && (($_SERVER['SCRIPT_NAME'] == '/local/api/out.php') || ($_SERVER['SCRIPT_NAME'] == '/login/token.php') ||  ($_SERVER['SCRIPT_NAME'] == '/webservice/rest/server.php') || ($_SERVER['SCRIPT_NAME'] == '/local/api/logintoken.php') || ($_SERVER['SCRIPT_NAME'] == '/local/api/picture-update.php') || ($_SERVER['SCRIPT_NAME'] == '/local/api/reset-password.php') || ($_SERVER['SCRIPT_NAME'] == '/local/api/feedback.php'))) {
    //print_r($_SERVER['SCRIPT_NAME']);die;
    $post_data = file_get_contents("php://input");
    $_POST = (!empty($post_data)) ? json_decode($post_data, true) : $_POST;
}
