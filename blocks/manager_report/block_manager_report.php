 ...
 *
 * @package    block_manager_report
 * @author     Ayush <aayush.yahoo@gmail.com>
 */

defined('MOODLE_INTERNAL') || die();

class block_manager_report extends block_base {
    /**
     * block initializations
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_manager_report');
    }
    ...
    public function get_content() {
        ...
        $this->content->text = $this->manager_element();
        $this->content->footer = '';
    ...
    public function manager_element(){
