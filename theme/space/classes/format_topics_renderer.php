 ...
 */
class theme_space_format_topics_renderer extends format_topics_renderer {
    ...
    public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
        ...
        $sectionbottomnav = '';
        $sectionbottomnav .= html_writer::start_tag('div', array('class' => 'section-navigation mdl-bottom justify-content-between'));
    ...
    protected function get_nav_links($course, $sections, $sectionno) {
        ...
        while ($back > 0 and empty($links['previous'])) {
            if ($canviewhidden || $sections[$back]->uservisible) {
                ...
                $previouslink .= "<span class='text'>";
                $previouslink .= get_section_name($course, $sections[$back])."</span>";
    ...
    protected function section_summary($section, $course, $mods) {
        $classattr = 'section main section-summary';
        $linkclasses = '';
    ...
    protected function section_activity_summary($section, $course, $mods) {
        ...
        if ($total > 0) {
            ...
            $output = html_writer::start_tag('div', array('class' => 'section-summary-activities mt-3 p-0'));
            ...
            $output .= "</div>";
            $output .= "</div><div class='progress-bar-text'>{$percent}%</div>";
            $output .= html_writer::end_tag('div');
        }
