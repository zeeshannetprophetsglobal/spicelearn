...
$url = $CFG->wwwroot.'/local/sitereport/ceo_author_report.php';
...
if ($ceo_author_report_cancel) {
    ...
    $searchurl = new moodle_url($CFG->wwwroot.'/local/sitereport/ceo_author_report.php',null);
    redirect($searchurl);
...
if($format){
    ...
    ceo_download_author_report($format,$dpt,$ecn,$startdate,$enddate);
...
echo $renderer->ceo_author_report($page,$dpt,$ecn,$startdate,$enddate);
