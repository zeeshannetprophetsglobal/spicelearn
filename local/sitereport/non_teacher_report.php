...
$url = $CFG->wwwroot.'/local/sitereport/non_teacher_report.php';
...
if ($author_report_cancel) {
    ...
    $searchurl = new moodle_url($CFG->wwwroot.'/local/sitereport/non_teacher_report.php',null);
...
if($format){
    ...
    download_non_instructor_report($format,$ecn,$startdate,$enddate); 
...
echo $renderer->non_teacher_report($page,$ecn,$startdate,$enddate);
